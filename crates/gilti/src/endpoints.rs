...
fn error(error: gilti_git::Error) -> axum::response::Response {
    let (status, message) = match error {
        gilti_git::Error::NotFound => (axum::http::StatusCode::NOT_FOUND, "not found\n"),
        gilti_git::Error::Internal(message) => {
